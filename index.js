...
async function run() {
  try {
    ...
    const serviceCollection = client
      .db("car_parts_manufacturer")
      .collection("services");
    const bookigCollection = client
      .db("car_parts_manufacturer")
      .collection("booking");
    ...
    app.post("/post-service", async (req, res) => {
      ...
      const result = await bookigCollection.insertOne(booking);
      res.send(result);
    });
    ...
    app.get("/get-orders/:email", async (req, res) => {
      ...
      const result = (await bookigCollection.find(filter).toArray()).reverse();
      res.send(result);
    });
